      ...
      <div className="card-body py-4">
        ...
        <div className="grid grid-cols-2 gap-3">
          <div className="rounded-lg bg-base-200/60 p-3">
            <div className="text-xs text-base-content uppercase tracking-wide mb-0.5">Pool</div>
            <div className="font-semibold text-primary text-lg">{formatCredits(collateralPool)}</div>
            <div className="text-xs text-base-content">Total liquidity (credits)</div>
          </div>
          <div className="rounded-lg bg-base-200/60 p-3">
            <div className="text-xs text-base-content uppercase tracking-wide mb-0.5">Fee</div>
            <div className="font-semibold text-lg">{feePercent}%</div>
            <div className="text-xs text-base-content">Per swap</div>
          </div>
          <div className="rounded-lg bg-success/10 p-3">
            <div className="text-xs text-base-content uppercase tracking-wide mb-0.5">YES reserve</div>
            <div className="font-semibold text-success text-lg">{formatCredits(yesReserve)}</div>
            <div className="text-xs text-base-content">AMM (credits)</div>
          </div>
          <div className="rounded-lg bg-error/10 p-3">
            <div className="text-xs text-base-content uppercase tracking-wide mb-0.5">NO reserve</div>
